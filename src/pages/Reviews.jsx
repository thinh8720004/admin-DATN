...
// import ProductTable from "@/components/product/ProductTable";
 // import Re from "@/components/product/ProductTable";
...
//   import ProductServices from "@/services/ProductServices";
  ...
  const Reviews = () => {
    ...
    return (
      <>
        <PageTitle>{"Quản lí Bình Luận"}</PageTitle>
            ...
            >
              ...
              <div className="flex-grow-0 md:flex-grow lg:flex-grow xl:flex-grow">
                <Select onChange={(e) => setSortedField(e.target.value)}>
                  ...
                  <option value="date-added-asc">{"Tăng dần theo ngày"}</option>
                  <option value="date-added-desc">{"Giảm dần theo ngày"}</option>
                </Select>
              </div>
            ...
            <Table>
              <TableHeader>
                <tr>
                  ...
                  <TableCell>{"ID Product & hình ẢNNH"}</TableCell>
